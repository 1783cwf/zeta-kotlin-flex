package com.zetaframework.file.strategy.impl

import com.zetaframework.exception.BusinessException
import com.zetaframework.file.model.FileInfo
import com.zetaframework.file.strategy.FileStrategy
import com.zetaframework.file.util.FileUtil
...
abstract class AbstractFileStrategy : FileStrategy {
    ...
    override fun upload(
        ...
        try {
            ...
            throw com.zetaframework.exception.BusinessException("文件上传失败")
        }
