package com.zetaframework.desensitization.annotation

import cn.hutool.core.util.DesensitizedUtil
import com.fasterxml.jackson.annotation.JacksonAnnotationsInside
import com.fasterxml.jackson.databind.annotation.JsonSerialize
import com.zetaframework.desensitization.serializer.DesensitizationJsonSerializer
...
annotation class Desensitization(
     ...
     * 脱敏规则无默认值，必填
     */
    val rule: DesensitizedUtil.DesensitizedType,
    /**
     * 打码方式，默认*号打码
     */
    val symbol: String = "*",
