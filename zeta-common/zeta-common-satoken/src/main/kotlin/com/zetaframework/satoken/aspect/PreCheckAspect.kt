package com.zetaframework.satoken.aspect
...
import com.zetaframework.satoken.annotation.PreCheckRole
...
class PreCheckAspect(private val ignoreProperties: IgnoreProperties) {
    companion object {
        ...
        const val POINTCUT_SIGN: String =
            "@within(com.zetaframework.satoken.annotation.PreCheckPermission) || " +
                "@annotation(com.zetaframework.satoken.annotation.PreCheckPermission) || " +
                "@within(com.zetaframework.satoken.annotation.PreCheckRole) || " +
                "@annotation(com.zetaframework.satoken.annotation.PreCheckRole)"
    }
     ...
     * @param method
     */
    private fun checkMethodAnnotation(
        replace: String,
        method: Method,
    ) {
     ...
     */
    private fun checkByAnnotation(
        replace: String,
        annotation: PreCheckPermission,
    ) {
